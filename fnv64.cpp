...
#define FNV_64_PRIME_LOW ((unsigned)0x1b3)	/* lower bits of FNV prime */
...
fnv_64_buf(void *buf, size_t len, Fnv64_t hval)
{
    ...
    unsigned int val[4];			/* hash value in base 2^16 */
    unsigned int tmp[4];			/* tmp 64 bit value */
